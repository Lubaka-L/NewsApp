...
import com.example.newsapp.databinding.FragmentNationBinding
...
class NationFragment : Fragment(), NewsAdapterDelegate {
    ...
    override fun onCreateView(
        ...
        binding = FragmentNationBinding.inflate(layoutInflater)
        return binding.root
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        viewModel = ViewModelProvider(this)[NationViewModel::class.java]

        newsRecyclerViewAdapter = NewsRecyclerViewAdapter(this)
        binding.nationRV.adapter = newsRecyclerViewAdapter


        lifecycleScope.launch {
            viewModel.nationNews.collectLatest { result ->
                when (result) {
